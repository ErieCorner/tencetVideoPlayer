...
package cn.onestravel.we55study.video.tecentvideoplaydemo.view;
...
import cn.onestravel.we55study.video.tecentvideoplaydemo.DemoApplication;
import cn.onestravel.we55study.video.tecentvideoplaydemo.TXPlayerAuthParam;
...
//        authBuilder.setSign("d6581029cb5fbe44f938b1b4fadbb0dc");
    ...
    private void initView(Context context) {
        ...
        mTxplayer.setRenderMode(TXLiveConstants.RENDER_MODE_FULL_FILL_SCREEN);
    ...
    private void loadAndPlay(VideoUrl videoUrl, int seekTime) {
        ...
        mCloudVideoView.setVisibility(VISIBLE);
